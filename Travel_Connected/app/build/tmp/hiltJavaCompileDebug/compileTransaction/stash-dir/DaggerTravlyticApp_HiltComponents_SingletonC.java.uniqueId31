...
public final class DaggerTravlyticApp_HiltComponents_SingletonC {
  private DaggerTravlyticApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public TravlyticApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements TravlyticApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public TravlyticApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements TravlyticApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TravlyticApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements TravlyticApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TravlyticApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements TravlyticApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TravlyticApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements TravlyticApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TravlyticApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements TravlyticApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TravlyticApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements TravlyticApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TravlyticApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends TravlyticApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends TravlyticApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends TravlyticApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends TravlyticApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends TravlyticApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityRetainedCImpl extends TravlyticApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends TravlyticApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends TravlyticApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideKnowledgeItemDaoProvider = DoubleCheck.provider(new SwitchingProvider<KnowledgeItemDao>(singletonCImpl, 2));
      this.knowledgeRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<KnowledgeRepository>(singletonCImpl, 1));
      this.provideEscalationLogDaoProvider = DoubleCheck.provider(new SwitchingProvider<EscalationLogDao>(singletonCImpl, 4));
      this.provideResponseLogDaoProvider = DoubleCheck.provider(new SwitchingProvider<ResponseLogDao>(singletonCImpl, 5));
      this.provideTrainingRuleDaoProvider = DoubleCheck.provider(new SwitchingProvider<TrainingRuleDao>(singletonCImpl, 6));
      this.geminiAgentProvider = DoubleCheck.provider(new SwitchingProvider<GeminiAgent>(singletonCImpl, 7));
      this.provideSummaryGeneratorProvider = DoubleCheck.provider(new SwitchingProvider<SummaryGenerator>(singletonCImpl, 8));
      this.provideTtsManagerProvider = DoubleCheck.provider(new SwitchingProvider<TtsManager>(singletonCImpl, 9));
    }

    @Override
    public void injectTravlyticApp(TravlyticApp travlyticApp) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.travlytic.app.data.repository.KnowledgeRepository 
          ...
          case 8: // com.travlytic.app.engine.SummaryGenerator 
          return (T) AppModule_ProvideSummaryGeneratorFactory.provideSummaryGenerator();

          case 9: // com.travlytic.app.engine.TtsManager 

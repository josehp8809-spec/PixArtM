...
public final class MainViewModel extends androidx.lifecycle.ViewModel {
    ...
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.Job setScheduleStart(int hour, int minute) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.Job setScheduleEnd(int hour, int minute) {
        return null;
    }
